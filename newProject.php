...
<body>
    ...
    <div class="new-project-wrapper">
        ...
        <?php if ($_SESSION["createProject"] === false): ?>
                <em id="instruct">Please fill out all required (*) fields</em>
        <?php endif; ?>
            ...
            <form method="post" action="php-processes/create-newProject" name="createNewProject">
                <div class="input-section">
                    ...
                    <input class="input" type="text" name="title" id="title"
                        placeholder="Awesome Title" required>
                    ...
                    <input class="input" type="date" name="startDate" id="startDate" value="<?=$today?>" required>
